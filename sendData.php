<?php
	...
	$sql = "INSERT INTO imVBoothDB_users (eventID,fullname,email,phonenumber,extradata,datetime) 
	...
	if (!im) {
 	...
 	$img_file = "./imageUploads/images/bBooth-$DTime.jpg"; 
	imagejpeg($im, $img_file, 100); 
    imagedestroy($im); 	
	
	$hyperlink_file = $siteURL."imageUploads/images/bBooth-$DTime.jpg";
	echo "\n".$hyperlink_file."\n"; 
